...
# Replace with your channel username or link
NEW_CHANNEL = "@YourNewChannel"  # or "https://t.me/yourchannel"
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if update.message.chat.type in ['group', 'supergroup']:
        ...
        await update.message.reply_text(
            f"{user_tag}, This channel is closed. Please join my another channel: {NEW_CHANNEL}",
            parse_mode='Markdown'
        )
